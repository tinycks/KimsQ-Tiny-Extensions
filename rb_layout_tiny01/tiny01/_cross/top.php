...
<ul id="mega-menu" class="mega-menu">
        ...
        <li<?php if($_themePage=='contactus'&&!$_themeConfig):?> class="thispage"<?php endif ?>><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&_themePage=contactus"><?php echo $d['layout']['contactus_name']?></a></li>
        <?php endif ?>
