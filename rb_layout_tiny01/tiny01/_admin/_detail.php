<div class="guide">
    <span class="b">디테일한 설정을 통해 나만의 디자인을 완성할 수 있습니다.</span>
    <br />
    <br />
    홈페이지 제목을 변경하거나 이미지로고,배경이미지 등을 설정할 수 있습니다.
    <br />
    아래의 설정을 통해 더 보기좋은 디자인을 완성해 보세요.
    <br />
    변경사항이 적용되지 않을 경우 새로고침해 주세요.
    <br />
</div>
...
<form name="themeForm" method="post" action="<?php echo $g['s']?>/" enctype="multipart/form-data" onsubmit="return configCheck1(this);">
    ...
    <table>
        ...
        <tr>
            ...
            크기
            <input type="text" name="title_size" class="input sf" value="<?php echo $d['layout']['title_size']?>" maxlength="3" />
            <span class="small">px</span> 색상
            <input type="text" name="title_color" id="title_color_" class="input sf1" value="<?php echo $d['layout']['title_color']?>" maxlength="7" />
            <img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['title_color'],1,6)?>&dropf=title_color_&callback=colorChange','색상선택',220,260,event,'','r');" /><span class="small">(공백:기본값)</span></td>
        </tr>
        <tr>
            <td class="t1">헤더 높이/배경색</td>
            <td class="t2">:</td>
            <td class="t3"> 높이
            <input type="text" name="height_header" class="input sf" value="<?php echo $d['layout']['height_header']?>" maxlength="3" />
            <span class="small">px</span> 배경색
            <input type="text" name="bg_header" id="bg_header_" class="input sf1" value="<?php echo $d['layout']['bg_header']?>" maxlength="7" />
            <img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['bg_header'],1,6)?>&dropf=bg_header_&callback=colorChange','색상선택',220,260,event,'','r');" /><span class="small">(공백:기본값)</span></td>
        </tr>
        <tr>
            ...
            <img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['bg_header_bt'],1,6)?>&dropf=bg_header_bt_&callback=colorChange','색상선택',220,260,event,'','r');" /><span class="small">(공백:기본값)</span></td>
        </tr>
        <tr>
            ...
            <img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['bg_header_bb'],1,6)?>&dropf=bg_header_bb_&callback=colorChange','색상선택',220,260,event,'','r');" /><span class="small">(공백:기본값)</span></td>
        </tr>
        <tr>
            <td class="t1">위치설정</td>
            <td class="t2">:</td>
            <td class="t3"> 타이틀(로고)
            <input type="text" name="title_t" class="input sf" value="<?php echo $d['layout']['title_t']?>" maxlength="3" />
            <span class="small">px</span> 멤버링크
            <input type="text" name="title_b" class="input sf" value="<?php echo $d['layout']['title_b']?>" maxlength="3" />
            <span class="small">px</span> 상단우측광고
            <input type="text" name="title_ad" class="input sf" value="<?php echo $d['layout']['title_ad']?>" maxlength="3" />
            <span class="small">px</span><span class="small">(최상단으로부터의 간격)</span></td>
        </tr>
        ...
        <tr>
            ...
            <img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['memberlink_color'],1,6)?>&dropf=memberlink_color_&callback=colorChange','색상선택',220,260,event,'','r');" /><span class="small">(공백:기본값)</span> 구분파이프
            <input type="text" name="split_color" id="split_color_" class="input sf1" value="<?php echo $d['layout']['split_color']?>" />
            <img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['split_color'],1,6)?>&dropf=split_color_&callback=colorChange','색상선택',220,260,event,'','r');" /><span class="small">(공백:기본값)</span></td>
        </tr>
        ...
        <tr>
            ...
            <img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['search_border'],1,6)?>&dropf=search_border_&callback=colorChange','색상선택',220,260,event,'','r');" /><span class="small">(공백:기본값)</span></td>
        </tr>
        ...
        <tr>
            ...
            <input type="checkbox" name="imglogo_use" value="1"<?php if($d['layout']['imglogo_use']):?> checked="checked"<?php endif ?> />
            사용함 </td>
        </tr>
        ...
        <tr>
            ...
            <td class="t2">:</td>
            <td class="t3">
            <input type="text" name="imglogo_w" class="input sf" value="<?php echo $d['layout']['imglogo_w']?>" maxlength="3" />
            *
            <input type="text" name="imglogo_h" class="input sf" value="<?php echo $d['layout']['imglogo_h']?>" maxlength="3" />
            픽셀 </td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <input type="checkbox" name="bg_use" value="1"<?php if($d['layout']['bg_use']):?> checked="checked"<?php endif ?> />
            사용함</td>
        </tr>
        ...
        <tr>
            <td class="t1">푸터 Address 편집</td>
            <td class="t2">:</td>
            <td class="t3">            <textarea name="address" rows="5" cols="70"><?php htmlspecialchars(readfile($g['path_layout'].$d['layout']['dir'].'/_var/_address.txt'))?></textarea></td>
        </tr>
