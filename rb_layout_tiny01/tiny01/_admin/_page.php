...
<?php $_pagejs=str_replace('.php','.js',$_page)?>
<tr>
<td class="p">
...
<td class="p">
    <?php if(is_file($_pagepage.$_pagejs)):?>
    <img src="<?php echo $g['img_core']?>/file/small/js.gif" alt="" />
    <a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=admin&amp;module=filemanager&amp;front=main&amp;iframe=Y&amp;pwd=<?php echo urlencode($_pagepage)?>&amp;editmode=Y&amp;file=<?php echo $_pagejs?>" target="_blank"><?php echo $_pagejs?></a>
    <i>(<?php echo getSizeFormat(filesize($_pagepage.$_pagejs),1)?>)</i>
    <?php else: ?>
    <i>없음</i>
    <?php endif ?>
</td>
...
<?php if(!$_i):?>
<tr>
<td colspan="4" class="none">페이지 파일이 없습니다.</td>
<?php endif ?>
</tbody>
</table>
